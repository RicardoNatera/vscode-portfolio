...
`,
  ...
  {
    title: "Push Anime",
    description: "Web app for browsing and downloading the latest anime episodes published on AnimeFLV, OtakusTV, and AnimeAV1. Includes sorting by most recent publications, episode grouping, and multi-source search engine.",
...
`,
  ...
  "contact.json": `{
  "name": "Ricardo Natera",
  "email": "ricardoantonionaterasubero@gmail.com",
  "location": "Nueva Esparta, Venezuela",
  "linkedin": "https://www.linkedin.com/in/natera-dev/",
  "github": "https://github.com/RicardoNatera",
  "message": "I’m currently open to job opportunities, collaborations, or simply a good professional conversation. Don’t hesitate to contact me!"
}
`,
};
